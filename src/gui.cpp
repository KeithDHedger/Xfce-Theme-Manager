	...
	if(addView==true)
		{
			...
			gtk_container_add((GtkContainer*)vbox,(GtkWidget*)tempIconView);
		}
...
//controls
	...
	addNewIcons(iconsScrollBox,"icons",icon_view);
	...
	addNewIcons(cursorsScrollBox,"cursors",icon_view);
	...
	addNewIcons(wallpapersScrollBox,"wallpapers",icon_view);
