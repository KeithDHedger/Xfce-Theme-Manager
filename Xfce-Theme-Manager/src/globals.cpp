...
{"Thèmes","Bourdures de fenêtres","Contrôles","Icônes","Curseurs","Fonds d'écran","Regénérer la base de données","Regénérer la BDD","Lancer Xfce-Composite-Editor","Ajustements de l'arrière plan","Luminosité","Saturation","Réinitialiser","Agencement des boutons","Sélection de la police","Gestionnaire de fenêtres","Applications","Taille du curseur","Réinitialiser le thème","Sauvegarder le thème","Avancés","Position du titre","Entrez le nom du thème...","Gauche","Centre","Droite","Auto","Centré","Mosaïque","Étiré","Adapté","Zoomé","Personnalisé","Options d'affichage","Afficher les thèmes système","N'afficher que les thèmes personnalisés","Supprimer le thème personnalisé","Gestionnaire de thèmes intégré","Un gestionnaire de thème intégrée pour Xfce 4.10","Très grands aperçus","Grands aperçus","Aperçus moyen","Petits aperçus","Tableau de bord","Dimension :","Aucun","Couleur pleine","Image","Style :	","Ficher :		","Opacité :	","Couleur :	","Procurez-vous le à http://gtk-apps.org","Moniteur"}
